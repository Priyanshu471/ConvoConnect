...
function FileUpload({ setState, file }) {
  ...
  const handleUpload = (e) => {
    ...
    uploadRef.on(
      "state_changed",
      (snapshot) => {
        let progress = (snapshot.bytesTransferred / snapshot.totalBytes) * 100; //it will give us the percentage of bytes that are transferred so far
  ...
  return (
    <div>
      ...
      >
        ...
        <DialogTitle id="alert-dialog-title">Send Image</DialogTitle>
